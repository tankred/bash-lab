...
# grep aki *.txt && echo "aki is here" || "aki 404" ## will too much info! 
grep aki ~/tmp/*.txt >/dev/null && echo "aki is here" || "aki 404"

# src: https://bash.cyberciti.biz/guide//dev/null_discards_unwanted_output
